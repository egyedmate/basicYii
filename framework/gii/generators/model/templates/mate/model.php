...
if($n == 1){
return Yii::t('<?php echo $tableName; ?>', '<?php echo $modelClass; ?>', $n);
}else{
return Yii::t('<?php echo $tableName; ?>', '<?php echo $modelClass . 's'; ?>', $n);
}
}
...
return array(
<?php
echo "// NOTE BY MATE: If it possible please use scenario and default value\n\n";
